...
cat("The most checked out material type is '", book, "', which surprised me a little because I thought it would be EBOOK")
cat("The most checked out book is '", checkout, "', and I personally have never heard of that book.")
cat("I wanted to know if the top sales book would be a book I know or one of my favorite, but it was not.")
cat("The year in which the most checked out material type is books is '", year1, "', which is to be expected since in '", year1, "' digital books were not too popular yet.")
cat("The year in which the most usage class checked out is digital is '", year2, "', which makes sense because more people are going digital these days.")
cat("The top 3 publishers based on the most number of check outs are '", top1, "', '", top2, "', '", top3, "', and I have only heard of HarperCollins.")
```
